    ...
    if (empty($messages)) {
        ...
        if (isset($_POST['contact_numbers'])) {
            ...
            foreach ($_POST['contact_numbers'] as $contact_no) {
                ...
                //query to insert contact number
...
if (isset($_GET['action']) && $_GET['action'] == "delete") {
    ...
    if (isset($_GET['id'])) {
        ...
        $id = $_GET['id'];
 //query to delete contact number
            ...
            <div class="flex flex-col content-wrapper">
                ...
                <form action="my-user-profile.php" method="post">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-row form">
                            <div class="form-item flex flex-col">
                                ...
                                <input type="text" name="nic" placeholder="NIC" value="<?php echo $customer['nic'] ?>" readonly>
                                <?php
                        ...
                        <div class="flex flex-row form">
                            <div class="form-item flex flex-col">
                                ...
                                <input type="text" name="home_no" placeholder="home_no" value="<?php echo $customer['home_no'] ?>">
                                <?php
                                ...
                                <input type="text" name="street" placeholder="street" value="<?php echo $customer['street'] ?>">
                                <?php
                                ...
                                <input type="text" name="city" placeholder="city" value="<?php echo $customer['city'] ?>">
                                <?php
                    ...
                    <div class="flex" style="margin-top: 10px">
                        <button type="submit" name="submit" class="btn btn-primary" style="margin-right: 10px;">Update Profile</button>
