        ...
        if(empty($errors)) {
            ...
            if($result) {
                if (mysqli_num_rows($result) == 1) {
                    ...
                    $_SESSION['engineer_id'] = $user['engineer_id'];
                    $_SESSION['first_name'] = $user['name'];
                    
                    header('Location: chief-engineer-dashboard.php'); 
                }
                else{
...
<head>
    ...
    <title>Chief Engineer Login | Your Road to Safety and Savings</title>
    <!--font awesome-->
...
<body>
    ...
    <div class="container">
        <div class="login flex">
            ...
            <form action="chief-engineer-login.php" method="post">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="email" name="email" placeholder="E-mail address" value="kumalsandaru@gmail.com">
                    <?php
                ...
                <div class="flex flex-col">
                    ...
                    <input type="password" name="password" placeholder="Password" value="kumal123">
                    <?php
